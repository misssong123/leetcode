...
class ValidSubstringCount3298 {
    /**
     * 解答成功:
     * 	执行耗时:50 ms,击败了55.15% 的Java用户
     * 	内存消耗:55.6 MB,击败了18.31% 的Java用户
     * @param word1
     * @param word2
     * @return
     */
    ...
    /**
     * 解答成功:
     * 	执行耗时:38 ms,击败了94.55% 的Java用户
     * 	内存消耗:55.2 MB,击败了39.03% 的Java用户
     * @param S
     * @param T
     * @return
     */
    ...
    /**
     * 解答成功:
     * 	执行耗时:100 ms,击败了37.27% 的Java用户
     * 	内存消耗:55.6 MB,击败了20.72% 的Java用户
     * @param word1
     * @param word2
     * @return
     */
