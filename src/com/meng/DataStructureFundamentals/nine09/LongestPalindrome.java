package com.meng.DataStructureFundamentals.nine09;
...
public class LongestPalindrome {
    ...
    public String longestPalindrome(String s) {
        ...
        int max = 0;
        String res = "";
        for(int i = 0 ; i < len -1 && (len - i) * 2 > max; i++){
            String left = expend(i,i,len,s);
            String right = expend(i,i+1,len,s);
            if (left.length() > max){
                max = left.length();
                res = left;
            }
    ...
    private String expend(int left, int right, int len,String s) {
        System.out.println("--------------------------");
