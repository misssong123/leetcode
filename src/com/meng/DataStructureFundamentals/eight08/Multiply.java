...
public class Multiply {
    ...
    public String multiply(String num1, String num2) {
        ...
        if(num1.length() > num2.length()){
            ...
            for(int i = len - 1 ; i >=0 ; i--){
                ...
                String s = multiplyNum(num, num1, len - i - 1);
                sum = addNum(s,sum);
            }
        }else {
            int len = num1.length();
            for(int i = len - 1 ; i >=0 ; i--){
                ...
                String s = multiplyNum(num, num2, len - i - 1);
                sum = addNum(s,sum);
            }
        }
        return sum;
    ...
    private String addNum(String num1,String num2){
        ...
        while (left >= 0 || right >=0 ){
            int lNum = left >=0 ? num1.charAt(left) -'0':0;
            int rNum = right >=0 ? num2.charAt(right) -'0':0;
            int sum = lNum + rNum + num;
            sb.append(sum%10);
            num = sum / 10;
            left -- ;
            right -- ;
    ...
    private String multiplyNum(int num1,String num2,int n){
        if (num1 == 0){
            return "0";
        }
        StringBuffer sb = new StringBuffer();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(demo.multiply("0","9"));
    }
