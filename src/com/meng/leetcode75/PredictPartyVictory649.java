 ...
 * 他们以一个基于轮为过程的投票进行。在每一轮中，每一位参议员都可以行使两项权利中的一 项：
...
public class PredictPartyVictory649 {
     ...
     * 详情
     * 10ms
     * 击败 73.65%使用 Java 的用户
     * 内存
     * 详情
     * 42.63MB
     * 击败 59.45%使用 Java 的用户
     * @param senate
     * @return
     */
    ...
    public static void main(String[] args) {
        PredictPartyVictory649 demo = new PredictPartyVictory649();
        System.out.println(demo.predictPartyVictory("DRRDRDRDRDDRDRDR"));
    }
}
