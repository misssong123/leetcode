package com.meng.dataStructureFoundation.seventh;
...
public class WordPattern {
    ...
    public boolean wordPattern(String pattern, String s) {
        ...
        Map<String,Character> cache1 = new HashMap<>();
        ...
        for(int i = 0; i < chars.length ; i++){
            char c = chars[i];
            String s2 = s1[i];
            if ((cache.get(c) != null && !cache.get(c).equals(s2)) ||( cache1.get(s2) != null && cache1.get(s2) != c) ){
                return false;
            }
            cache.put(c,s2);
            cache1.put(s2,c);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(demo.wordPattern("abc","dog cat cat"));
    }
}
